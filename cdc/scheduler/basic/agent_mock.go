...
func (m *MockProcessorMessenger) FinishTableOperation(ctx cdcContext.Context, tableID model.TableID, epoch protocol.ProcessorEpoch) (bool, error) {
	args := m.Called(ctx, tableID, epoch)
	return args.Bool(0), args.Error(1)
}

// SyncTaskStatuses marks this function as being called.
func (m *MockProcessorMessenger) SyncTaskStatuses(ctx cdcContext.Context, epoch protocol.ProcessorEpoch, adding, removing, running []model.TableID) (bool, error) {
