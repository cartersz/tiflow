...
// scheduler.ScheduleDispatcherCommunicator.
type BaseScheduleDispatcher struct {
	...
	communicator scheduler.ScheduleDispatcherCommunicator
	logger       *zap.Logger
}
...
func (s *BaseScheduleDispatcher) Tick(
	...
	if err != nil {
		return scheduler.CheckpointCannotProceed, scheduler.CheckpointCannotProceed, errors.Trace(err)
	}
	if !done {
